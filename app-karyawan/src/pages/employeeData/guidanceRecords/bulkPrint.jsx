...
function GuidanceRecordBulkPrintPage() {
	...
	let content = (
		<Stack alignItems="center" spacing={1} py={10}>
			<Typography variant="h6">Tidak ada data untuk dicetak.</Typography>
				...
				>
					<Box>
						<Typography variant="h5" fontWeight={700}>
							Print A4 Bimbingan & Pengarahan
						</Typography>
						<Typography variant="body2" color="text.secondary">
							{records.length} formulir siap dicetak.
						</Typography>
					</Box>
...
export default GuidanceRecordBulkPrintPage;
